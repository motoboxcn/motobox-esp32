...
// IMAGE DATA: assets/dianliang3.png
const LV_ATTRIBUTE_MEM_ALIGN uint8_t ui_img_dianliang3_png_data[] = {
...
const lv_img_dsc_t ui_img_dianliang3_png = {
   .header.always_zero = 0,
   .header.w = 16,
   .header.h = 16,
   .data_size = sizeof(ui_img_dianliang3_png_data),
   .header.cf = LV_IMG_CF_TRUE_COLOR_ALPHA,
   .data = ui_img_dianliang3_png_data};
